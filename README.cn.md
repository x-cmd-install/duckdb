...
[![x-cmd/install — duckdb Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/duckdb.svg?lang=zh)](https://x-cmd.com/install/duckdb)
...
合计: **1,204,688** 行代码（覆盖前 5 种语言、共 **5410** 个文件）。
...
- **上游仓库**: <https://github.com/duckdb/duckdb>
- **官网**: <http://www.duckdb.org>
- **许可证**: MIT
...
- **Star**: 41,653 · **Fork**: 3,820 · **开放 issue**: 7,693 · **贡献者**: 694

## 累计统计

- **发布数**: 63 · **已合并 PR**: 12342 · **开放 PR**: 314 · **已关闭 issue**: 7125 · **开放 issue**: 568 · **提交数**: 85586
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/duckdb.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T05:43:32Z._
